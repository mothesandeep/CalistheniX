...
Contains:
  ...
  - SEED                      : main training exercises per routine (Push A/B, Pull A/B, Legs A/B)
  - DEFAULT_WORKOUT_PHASES    : warmup + cooldown exercise assignments per routine
  - SEED_VERSION             : idempotency tag (reseed only if version differs)
"""

# ── Seed version tag ──────────────────────────────────────────────────────────
# Increment this whenever SEED or DEFAULT_WORKOUT_PHASES changes so that
