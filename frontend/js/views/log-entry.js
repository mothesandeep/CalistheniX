      ...
      ` : `
        <div class="card">
          <form onsubmit="handleSaveReps(event)" style="padding:16px; display:flex; flex-direction:column; gap:16px;">
            ...
            <div>
              <label style="display:block; font-size:12px; font-weight:600; color:var(--text-muted); margin-bottom:6px;">Added Weight (kg, optional)</label>
              <input type="number" name="weight_kg" step="0.5" class="form-input" placeholder="e.g. 5" />
            </div>
            <div>
              <label style="display:block; font-size:12px; font-weight:600; color:var(--text-muted); margin-bottom:6px;">RPE (Rating of Perceived Exertion)</label>
